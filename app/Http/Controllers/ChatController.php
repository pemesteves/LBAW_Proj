...
class ChatController extends Controller{
    ...
    public function get_chat(){
      ...
      return view ('pages.chat', ['css' => ['navbar.css', 'chat.css'], 'js' =>['chat.js'], 'chat' => null, 'can_create_events' => Auth::user()->userable->regular_userable_type == 'App\Organization', 'notifications' =>$notifications]);
    }
