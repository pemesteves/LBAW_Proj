...
insert into public."user" ("name", "email", "password") values('Admin1', 'admin1@gg.pt', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918'); --admin
insert into public."user" ("name", "email", "password") values('Joaquim Rodrigues', 'jokinho@feup.pt', '61be55a8e2f6b4e172338bddf184d6dbee29c98853e0a0485ecee7f27b9af0b4'); --aaaa
insert into public."user" ("name", "email", "password") values('Paulo Tavares', 'paulot@flup.pt', '37d43d21680eea509d56b0b9aa90e986b068c6c3ebe5f6e31199d94d1d99920f'); --1234pass
insert into public."user" ("name", "email", "password") values('AEISEP', 'aeisep@isep.pt', '2371eed6bc20f1a21a1b02d963db2966c0f0b12b42153b0caf181416a2c09eae'); --yoyo10
insert into public."user" ("name", "email", "password") values('Gustavo Torres', 'tgusta@feup.pt', '1727619a97994f63beb35ab12c792972b4bfbebc6fbbaa0621a31afdbc725268'); --tgustamucho
insert into public."user" ("name", "email", "password") values('Pedro Esteves', 'pmesteves@feup.pt', '80cfa04f6ef471fef3a12581ca0ef857af748aa19463ea0292e4a9c310a4dae9'); --estevesboss
insert into public."user" ("name", "email", "password") values ('Vitor Ventuzelos', 'berserking@feup.pt', '979d2b82d1ed2c6f23406e898b9adb9060090501928654278eefff39a9fe15f4'); --berserking_idiot
insert into public."user" ("name", "email", "password") values ('José Martins', 'martins@flup.pt', '4447a0a857c5856a65be0b6d88e522930d60cc70cd87fc5a97ef5f9b29472e1f'); --martins
insert into public."user" ("name", "email", "password") values ('Marta Camões', 'mcamoes@fcup.pt', '919591ee58ee6ce7cec959d2a0d9130e7cf111d7ddafa15dc5283d74a2cb3a2a'); --123p
insert into public."user" ("name", "email", "password") values ('Diana Magalhães', 'dmaga@flup.pt', 'b3d17ebbe4f2b75d27b6309cfaae1487b667301a73951e7d523a039cd2dfe110'); --password12
insert into public."user" ("name", "email", "password") values ('Tiago Pessoa', 'tpessoa@isep.pt', '2c8c79ee2d9b918b6839430f08cef4c811316c33d06560c7223975e3496fb20f'); --hacked91
insert into public."user" ("name", "email", "password") values ('Ricardo Pinto', 'rpinto@fmup.pt', '36fa35b7423a57975566cccb407a11667c166b92a7a6b8bf1a0e9d8accf8c417'); --debugger99
insert into public."user" ("name", "email", "password") values ('Maria Soares', 'msoares@icbas.pt', 'a36d932abb39c80c3f573c08b7a2260e0555d053eeb9cacab9a3406b02d2330b'); --12345p
insert into public."user" ("name", "email", "password") values ('Francisco Costa', 'fcosta@ffup.pt', '1ba3d16e9881959f8c9a9762854f72c6e6321cdd44358a10a4e939033117eab9'); --pass2
insert into public."user" ("name", "email", "password") values ('José Silva', 'runcolho@fadeup.pt', 'e6c3da5b206634d7f3f3586d747ffdb36b5c675757b380c6a5fe5c570c714349'); --pass1
insert into public."user" ("name", "email", "password") values ('Miguel Alvim', 'malvim21@fadeup.pt', 'cb71cd3f59909532b783257f5f97d0502af258231f9d17cbe762799c0bb4a0f6'); --pass0
insert into public."user" ("name", "email", "password") values ('Dinis Pereira', 'dinpereira@fmup.pt', '1958e0a5696c86a9a147b27eb7b5c828fd8f99921fb7a1c068fb2d4860f85cd0'); --lbaw2034
insert into public."user" ("name", "email", "password") values ('Soraia Tavares', 'stavares@ffup.pt', '7d9187aec886a65a920d3b4a2e3eb66c771510255de4f02a1b0c67a1be856c33'); --lbaw
insert into public."user" ("name", "email", "password") values ('Osvaldo Antunes', 'oantunes@fadeup.pt', 'adf1a868d88c0f53317e0dcbfb982c19438f5c46c14725dc24e837bd75afb0cb'); --query10
insert into public."user" ("name", "email", "password") values ('Mariana Castro', 'mcastro@fcup.pt', 'a2979efbe3ef341d34ba03d1493da9d9282c2906710f33311e72dfe0b67b7373'); --sql2
insert into public."user" ("name", "email", "password") values ('Ana Faria', 'afaria@fep.pt', '0fa83a5d1a9db56f287856c263fb94c8d579fd8916750d67f7b78d1919dfa7e5'); --turbulencia2725
insert into public."user" ("name", "email", "password") values ('Rui Cardoso', 'rcardoso@fep.pt', 'bbe41015c3f1053c527579a7a45b5531c93ac11c7d14664465b68903a6736e34'); --bazofi10
