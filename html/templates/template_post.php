...
<div class="card mb-3" style="max-width:70%;margin:5% 15%">
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#postModal-<?=$id?>" style="text-align:left; color: inherit; border: none; padding: 0; font: inherit; cursor: pointer; outline: inherit;"> 
