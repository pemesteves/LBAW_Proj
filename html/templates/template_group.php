...
<div class="card mb-3 border rounded" style="min-width: 540px;max-width:80%;margin:5% auto">
    <div class="row no-gutters">
        <div class="card text-center col-md-3" style="border:none;border-radius:0;height:100%;">
            <img src="http://www.pluspixel.com.br/wp-content/uploads/services-socialmediamarketing-optimized.png" class="card-img-top mx-auto d-block" alt="..." style="border-radius:50%; max-width:70%; padding-top:0.8rem">
        </div>
